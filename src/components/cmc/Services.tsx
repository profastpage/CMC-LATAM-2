          ...
          {t.services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-card rounded-2xl p-6 sm:p-8 lg:p-10 shadow-sm hover:shadow-xl transition-all duration-500 border border-border/60 hover:border-green/30 hover:-translate-y-1 text-center"
              >
                {/* Icon */}
                <div className="w-16 h-16 sm:w-18 sm:h-18 mx-auto flex items-center justify-center bg-green/10 rounded-2xl mb-6 group-hover:bg-green group-hover:scale-110 transition-all duration-500">
                  <Icon className="w-8 h-8 sm:w-9 sm:h-9 text-green group-hover:text-white transition-colors duration-500" />
                </div>
